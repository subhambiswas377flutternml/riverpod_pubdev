...
abstract class $PackageCopyWith<$Res> {
  ...
  @useResult
  $Res call({String packageName, String packageDescription});
}
...
class _$_Package implements _Package {
  _$_Package({required this.packageName, required this.packageDescription});
  ...
  @override
  String toString() {
    return 'Package(packageName: $packageName, packageDescription: $packageDescription)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, packageName, packageDescription);
...
abstract class _Package implements Package {
  factory _Package(
      ...
      required final String packageDescription}) = _$_Package;
